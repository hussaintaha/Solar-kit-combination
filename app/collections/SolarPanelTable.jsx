  ...
  const getSolarPanelProducts = async () => {
    try {
      ...
      const response = await fetch(
        `/api/getSolarPanelProducts/?selectHarvestValue=${selectHarvestValue}`,
      );
        ...
        {loading ? (
          ...
          <>
            <div className="solar-panel-container">
              ...
              <div className="charge-controller">
                <ChargeControllerTable
                  selectHarvestValue={selectHarvestValue}
                />
              </div>
              <div className="battery-option">
