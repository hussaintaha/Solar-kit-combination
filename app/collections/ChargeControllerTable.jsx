    ...
    try {
      const savereorderitmesAPI = await fetch("/api/saveReorderedItmes", {
        ...
        body: JSON.stringify({
          ...
          collection: "chargeControllerProducts",
        }),
      });
    ...
    if (selectHarvestValue) {
      try {
        ...
        const airConditionerAPI = await fetch(
          "/api/selectChargeControllerProducts",
          {
            method: "POST",
  ...
  const addChargeControllerProducts = async () => {
    try {
      ...
      if (selectHarvestValue) {
        ...
        const airConditionerAPI = await fetch(
          "/api/addChargeControllerProducts",
          {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ selectHarvestValue, selected }),
  ...
  const getChargeControllerProducts = async () => {
    try {
      ...
      const response = await fetch(
        `/api/getChargeControllerProducts/?selectHarvestValue=${selectHarvestValue}`,
      );
